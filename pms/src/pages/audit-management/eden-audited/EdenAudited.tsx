 ...
 * @LastEditTime: 2024-09-30 21:17:17
...
export const EdenAudited = <T extends AuditTaskType>(): React.ReactNode => {
  ...
  return (
    <PageContextProvider value={{ tableActionRef, state, dispatch }}>
      <PageContainer header={{ title: null }}>
        <AuditTaskList auditedStatus={AuditStatus.AUDITED} product={2} />
      </PageContainer>
    </PageContextProvider>
  );
};
